    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            'Bibwoe Basic Instructions Books While on Earth, has Topics on Creation, Law, USA and World Governments, Life Matters. Our Main focus is the Re-Creation of Mankind to the Spiritual Beings you have forgotten tags, as you only live in the Flesh. Your Soul and Spirit you deny.',
          email: 'donaldboulton@gmail.com',
          founder: {
            '@id': 'https://donboulton.com',
          },
