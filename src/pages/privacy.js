    ...
    <div className="wrapper">
      ...
      >
        ...
        <p>
          ...
          <p>
            First and foremost, I will never share your email address or any
            other personal information to anyone without your direct consent.
          </p>
        </p>
      </Box>
      <h2>Log Files</h2>
      ...
      <p>
        ...
        learn about when, from where, and how often traffic flows to this site.
      ...
      <div>
        ...
        <p>
          🍪 When you visit this site "convenience" cookies are stored on your
          computer when you submit a comment to help you log in faster to 🔗 \*{" "}
          <Link yo="https://twitter.com/donboulton">Twitter</Link> the next time
          you do a tweet.
        </p>
        <p>
          ...
          more information regarding their practices and how to opt-out.
        </p>
        <p>
        ...
        <p>
          🔗 \*{" "}
          <Link to="https://www.privacypolicies.com/blog/eu-cookie-law/">
        ...
        <p>
          🔗 \*{" "}
          <Link to="https://www.cookiesandyou.com/disable-cookies/windows/edge/s">
        ...
        <p>
          ...
          \_\_utma cookie exists, this will be recorded as the users’ first
          visit and a \_\_utma cookie will be set. If a \_\_utma cookie is
          already in place, the expiration time is reset and the user is
          recorded as a return visitor.
        </p>
        <p>- \_\_utmb</p>
        <p>
          🤚 This cookie is used to determine a new session. The cookie is set
          when the ga.js library executes and there is no \_\_utmb cookie in
        ...
        <p>
          From Stackoverflow: 🔗 \*{" "}
          <Link to="https://stackoverflow.com/questions/1823406/what-does-utma-mean">
            What does \_\_utma mean?
          </Link>
        </p>
        <p>- \_\_utmv</p>
        <p>
          🤚 This cookie is used for storing visitor-level custom variable data.
          It is created when the \_\_setCustomVar method is used with a visitor
          level custom variable. Like the \_\_utma cookie, this cookie expires
          after 2 years and is reset each time the user visits your site before
        ...
        <p>
          These cookies contain no personally identifiable information but they
          will use your computer's IP address to know from where in the world
        ...
        <p>
          🔗 \*{" "}
          <Link to="https://tools.google.com/dlpage/gaoptout?hl=None">
        ...
        <p>
          ...
          platform. It is reported by them as being used for website analytics.
        </p>
        ...
        It has been found as a First Party cookie on 277 websites and a Third
        Party cookie on 71 websites. It has been found as a Persistent cookie on
        348 websites, with an average life span of 725 days.
        <p>It has been found as a Session cookie on 0 websites.</p>
        <p>
          Note: Many technologies or services use cookies that will be common to
          different websites and can be identified by name alone. However this
          is not always true. More specific information can sometimes be found
          with a website based search.
        </p>
        <h2>Privacy Google</h2>
        <p>
          🔗 \*{" "}
          <Link to="https://www.google.com/analytics/learn/privacy.html">
            Privacy Google
          </Link>
        </p>
        <p>
        ...
        after clicking on a link or ad banner that takes you to the site of one
        of their merchants.
        <h3>Read AdSense Policy</h3>
        🔗 \*{" "}
        <Link to="https://support.google.com/adsense/bin/answer.py?hl=en&answer=48182">
          AdSense Policy
        </Link>
        <h3>Create Your Own</h3>
        <p>🦸 Google AdSense Privacy Policy creator</p>
        🔗 \*{" "}
        <Link to="https://www.termsfeed.com/blog/privacy-policy-google-adsense/">
          Google AdSense
        </Link>
        <h2>Subscriptions</h2>
        <p>
          If you choose to sign up for our Subscriptions email newsletter (we
          hope you will), we use Netlify Forms to my SlackBot. You’re free to
          unsubscribe at any time. If you want us to delete your entire history
          at any time, contact donboulton@gmail.com and we’ll do that.
        </p>
        <p>We’ll email you about:</p>
        <p>
          New articles we think you will be interested in reading. Products that
          we think you will be interested in learning about. We won’t sell or
          rent your data to anyone else.
        </p>
        <h2>Donation Policy</h2>
        🩸 All Donations thought our external pay sites and or through our
        PayPal buttons will not be refundable, as they are a donation to a free
        website designer, that has limited ability's to do money transfers back
        to you. Thank You for your donations to Bibwoe.com.
        <h2> Comment Policy</h2>
        🩸 We want you to feel at home when you post a comment on Bibwoe.com. We
        want everyone to feel at home posting comments on Bibwoe.com. We don’t
        know what your home is like, but we know how we expect people to behave
        when they visit ours. That’s why we reserve the right to delete comments
        and ban users as needed to keep the comment threads here civil and
        substantive.
        <h3>1 house rule is simple</h3>
        <h4>Don’t be a jerk</h4>
        <p>
          Want to be the kind of commenter we’d love to bring home to
          Thanksgiving dinner? Here’s what we like to see in comments:
        </p>
        <p>
          Weigh in with smart, informed ideas that contribute further to the
          story.
        </p>
        <p>
        ...
        <p>
          Demonstrate and share the intelligence, wisdom, and humor we know you
          possess.
        </p>
        ...
        <div>
          <ul>
            <li>
              - I became an affiliate to earn revenue towards the costs of
              running and maintaining this website. Where I have direct control
              over which ads are served on this website I offer only products
              that are directly related to the topic of this website and
              products that a reader/subscriber would have a genuine interest in
              or need of.
            </li>
            <li>
              - I do not and will not recommend a product just for the sake of
              making money.
            </li>
            <li>
              - I do not let the compensation I receive influence the content,
              topics, posts, or opinions expressed on this website.
            </li>
            <li>
              - I respect and value my readers too much to write anything other
              than my own genuine and objective opinions and advice.
            </li>
          </ul>
        </div>
        <p>
          Just like this website, my Disclosure Policy is a work in progress. As
          the revenue streams evolve, so will this page.
        </p>
        <h2>Attribution</h2>
        Working
        <h2> Purchases</h2>
